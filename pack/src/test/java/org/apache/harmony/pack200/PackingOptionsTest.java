...
public class PackingOptionsTest extends TestCase {
    ...
    public void testKeepFileOrder() throws Exception {
        ...
        Pack200Archive archive = new Pack200Archive(in, out, options);
	try {
	    archive.pack();
        ...
        org.apache.harmony.unpack200.UnPack200Archive u2archive = new org.apache.harmony.unpack200.UnPack200Archive(
                in2, out2);
	try {
	    u2archive.unpack();
	} catch (RuntimeException e){
        ...
        File compareFile = new File(Pack200Archive.class.getResource(
                "/org/apache/harmony/pack200/tests/sqlUnpacked.jar").toURI());
        ...
        options.setKeepFileOrder(false);
        options.setGzip(false);
        archive = new Pack200Archive(in, out, options);
	try {
	    archive.pack();
	} catch (RuntimeException e){
	    e.printStackTrace(System.err);
        ...
        u2archive = new org.apache.harmony.unpack200.UnPack200Archive(in2, out2);
	try {
	    u2archive.unpack();
	} catch (RuntimeException e){
	    e.printStackTrace(System.err);
        ...
        compareFile = new File(Pack200Archive.class.getResource(
                "/org/apache/harmony/pack200/tests/sqlUnpacked.jar").toURI());
	...
	try {
        ...
        u2archive = new org.apache.harmony.unpack200.UnPack200Archive(in3, out3);
	try {
	    u2archive.unpack();
	} catch (RuntimeException e){
	    e.printStackTrace(System.err);
    ...
    public void testNewAttributes() throws Exception {
        ...
        Pack200Archive ar = new Pack200Archive(in, out, options);
	try {
	    ar.pack();
	} catch (RuntimeException e){
	    e.printStackTrace(System.err);
...
//        compareFiles(jarFile, jarFile2);
    ...
    public void testE0() throws Pack200Exception, IOException,
            URISyntaxException {
        File f1 = new File(Pack200Archive.class.getResource(
    ...
    // JarInputStream(Pack200Archive.class.getResourceAsStream("/org/apache/harmony/pack200/tests/jndi.jar"));
    // file = File.createTempFile("jndiE0", ".pack");
    // out = new FileOutputStream(file);
    // Pack200Archive archive = new Pack200Archive(inputStream, out, false);
    // archive.setEffort(0);
    // archive.pack();
    // inputStream.close();
    // out.close();
